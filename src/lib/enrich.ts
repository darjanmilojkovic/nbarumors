...
Place them once each and only where it earns its space. Once per person is enough; after that person's first mention, the surname alone. Once EACH, not once per summary: placing the first person named does not cover the second, and a merge is exactly where the second one slips through unplaced. The possessive is for a name the reader could not otherwise place.
