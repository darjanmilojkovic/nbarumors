...
export const SEED_SOURCES: SeedSource[] = [
  ...
  },
  {
    slug: "nbc-nba",
    name: "NBC Sports",
    homepageUrl: "https://www.nbcsports.com/nba/news",
    feedUrl: "https://www.nbcsports.com/nba/news.atom",
    kind: "rss",
    enabled: true,
    note: "Atom, advertised on the news page; /nba/rss and /nba/news/rss both 404. Ten items spanning two days, all NBA, including their daily rumors roundup. The feed carries a one-line pull quote (~67 characters) and no author, so it depends on the article fetch: 5/5 pages returned full text from a laptop.",
  },
  {
    slug: "bleacher-report-nba",
    name: "Bleacher Report",
    homepageUrl: "https://bleacherreport.com/nba-rumors",
    feedUrl: "https://feeds.bleacherreport.com/articles",
    kind: "rss",
    enabled: true,
    note: "The whole site in one feed — no NBA-only feed exists and tag_id is ignored. Ingest keeps only items tagged exactly NBA (REQUIRED_CATEGORY in ingest.ts): about 72 of 584 a week. Freshest feed checked, newest item minutes old. ~144 characters an item; article pages gave 924-1,879 from a laptop.",
  },
  {
